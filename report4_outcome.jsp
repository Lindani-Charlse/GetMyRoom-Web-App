...
<head>
    ...
    <title>Room Occupancy by Average Percentage - GetMyRoom</title>
...
<body>
    ...
    <div class="container admin-container">
        ...
        <div class="content">
            ...
            <h1>Room Occupancy by Average Percentage</h1>
            <div class="live-time" id="liveTime"></div>
            <c:if test="${not empty message}">
                <p class="${messageType == 'success' ? 'success-message' : 'error-message'}">${message}</p>
            </c:if>

            <form action="report4Servlet.do" method="GET" style="margin-bottom: 20px;">
                <label for="percentageRange">Average Percentage:</label>
                <select name="percentageRange" id="percentageRange">
                    <option value="All" ${param.percentageRange == 'All' || empty param.percentageRange ? 'selected' : ''}>All</option>
                    <option value="Below 50" ${param.percentageRange == 'Below 50' ? 'selected' : ''}>Below 50%</option>
                    <option value="50-75" ${param.percentageRange == '50-75' ? 'selected' : ''}>50%–75%</option>
                    <option value="Above 75" ${param.percentageRange == 'Above 75' ? 'selected' : ''}>Above 75%</option>
                </select>
