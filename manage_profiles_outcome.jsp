...
<head>
    ...
    <title>Manage Profiles - GetMyRoom</title>
...
<body>
    ...
    <div class="container admin-container">
        ...
        <div class="content">
            ...
            <a href="create_profile.jsp" class="submit-button"><i class="fas fa-user-plus"></i> Create Profile</a>
                    ...
                    <tbody>
                        <c:forEach var="profile" items="${profileList}">
                            <tr>
                                ...
                                <td>
                                    <a href="EditProfileServlet.do?profileId=${profile.profileId}" class="action-button edit-button"><i class="fas fa-edit"></i> Edit</a>
                                    <form action="DeleteProfileServlet.do" method="POST" style="display:inline;" onsubmit="return confirm('Are you sure you want to delete profile ${profile.profileId}?');">
