...
<head>
    ...
    <title>Room Occupancy by Gender - GetMyRoom</title>
...
<body>
    ...
    <div class="container admin-container">
        ...
        <div class="content">
            ...
            <h1>Room Occupancy by Gender</h1>
            <div class="live-time" id="liveTime"></div>
            <c:if test="${not empty message}">
                <p class="${messageType == 'success' ? 'success-message' : 'error-message'}">${message}</p>
            </c:if>

            <form action="report1Servlet.do" method="GET" style="margin-bottom: 20px;">
                <label for="gender">Gender:</label>
                <select name="gender" id="gender">
                    <option value="" ${empty param.gender ? 'selected' : ''}>All</option>
            ...
            <c:if test="${empty reportData}">
                <p>No data available for the selected gender.</p>
            </c:if>
        </div>
    </div>
